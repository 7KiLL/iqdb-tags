...
var AnimePictures = {
    ...
    render: function () {
        ...
        var settings = '<h1 class='+ Global.name +' id="sett">Settings</h1><br>';
        var chars = iqdb.createInput('checkbox', '_chars', 'Characters?');
        var artist = iqdb.createInput('checkbox', '_artist', 'Artist?');
...
var MangaDrawing  = {
    ...
    status: 'alpha',
    selectors: {
        copyright: '.views-field views-field-tid-2 > field-content > a > span',
        artist: '.views-field views-field-tid-3 > field-content > a > span',
        characters: '.views-field views-field-tid-1 > field-content > a > span'
    },
    images: [
